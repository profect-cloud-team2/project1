...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler({com.example.demo.cart.exception.UnauthorizedException.class,
		com.example.demo.order.exception.UnauthorizedException.class,
		com.example.demo.payment.exception.UnauthorizedException.class})
